 ...
 */
public class GetSpeedHistoryModelImp extends BaseModel implements MsgModel<JSONObject> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public GetSpeedHistoryModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadMsg(Map<String, String> map, final IBaseRequestCallBack<JSONObject> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getSpeedHistory(map)
