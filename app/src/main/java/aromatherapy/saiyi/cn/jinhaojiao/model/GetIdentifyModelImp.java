 ...
 */
public class GetIdentifyModelImp extends BaseModel implements MsgModel<JSONObject> {

    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public GetIdentifyModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void loadMsg(Map<String, String> map, final IBaseRequestCallBack<JSONObject> iBaseRequestCallBack) {
        mCompositeSubscription.add(serviceApi.getIdentify(map)
