 ...
 */
public class Year extends BaseFragment implements OnChartValueSelectedListener {
    @ViewInject(R.id.line_chart)
    LineChart mChart;
    @ViewInject(R.id.textClock)
    TextView textClock;

    @ViewInject(R.id.year_data)
    TextView year_data;

    @ViewInject(R.id.year_tiem)
    TextView year_tiem;

    @ViewInject(R.id.year_data_tv)
    TextView year_data_tv;
    @ViewInject(R.id.year_kaluli)
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        year_data.setText(yy[e.getXIndex()]);
