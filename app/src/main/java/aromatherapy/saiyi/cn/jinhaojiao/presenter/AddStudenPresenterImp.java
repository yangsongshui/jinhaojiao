 ...
 */
public class AddStudenPresenterImp extends BasePresenterImp<MsgView,JSONObject> implements MsgPresenter {
     ...
     */
    public AddStudenPresenterImp(MsgView view, Context context) {
        super(view);
